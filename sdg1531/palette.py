"""The 148 CSS4 hex values, in matplotlib.colors.cnames insertion order.

Vendored so scheme.LandCoverScheme.palette() reproduces indicator_model.py:248-250
byte for byte without importing matplotlib. Order is load-bearing: the legacy code
seeds random with 100 and samples this exact sequence.
